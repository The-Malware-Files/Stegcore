...
| `--decoy` | none | Decoy payload file (required with `--deniable`) |
...
| `-o, --output` | none | Report output path (required for html/csv) |
...
(Clean / Suspicious / Likely Stego) with an overall score 0 to 100.
...
Returns a 0.0 to 1.0 suitability score. Higher is better. Considers
...
and open-source projects, or a [commercial licence](COMMERCIAL.md) for
